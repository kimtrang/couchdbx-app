...
OSStatus PrivilegedInstall(NSArray* sourceFiles, NSString* destinationDir, NSError** outError) {
...
OSStatus UnprivilegedInstall(NSArray* sourceFiles, NSString* destinationDir, NSError** outError)
{
